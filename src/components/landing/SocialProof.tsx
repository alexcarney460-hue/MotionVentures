        ...
        <div className="grid grid-cols-2 gap-6 sm:gap-8 md:grid-cols-4 mb-12 sm:mb-24">
          {STATS.map((stat) => (
            <div key={stat.label} data-stat className="text-center">
              <div className="font-[var(--font-sora)] text-3xl font-extrabold text-[#a78bfa] sm:text-4xl md:text-5xl">
                {stat.value}
              </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.company}
              data-quote
              className="rounded-xl sm:rounded-2xl border border-white/[0.06] bg-[#111] p-5 sm:p-8 md:p-10"
            >
              ...
              <p className="text-base sm:text-lg leading-relaxed text-[#ccc] font-medium">
                &ldquo;{t.quote}&rdquo;
              </p>
