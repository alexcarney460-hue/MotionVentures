  ...
  return (
    <section ref={sectionRef} className="relative py-32 bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 data-cta-reveal className="font-[var(--font-sora)] text-4xl font-extrabold tracking-[-0.03em] text-white sm:text-5xl md:text-6xl">
        ...
        <div data-cta-reveal className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/contact"
            className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#a78bfa] via-[#8b5cf6] to-[#38bdf8] px-10 py-4 text-sm font-bold text-white uppercase tracking-wider transition-all duration-300 hover:shadow-[0_0_40px_rgba(139,92,246,0.3)] hover:scale-[1.02]"
          >
            Start a project
          ...
          <Link
            href="/intelligence"
            className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-10 py-4 text-sm font-bold text-white uppercase tracking-wider backdrop-blur-sm transition-all duration-300 hover:border-white/20 hover:bg-white/10"
          >
            Try CrowdTest free
          </Link>
        </div>
