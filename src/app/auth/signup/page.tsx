    ...
    return (
      <div className="min-h-screen bg-[color:var(--mv-canvas)] flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-bold text-white font-[var(--font-sora)]">Check your email</h1>
          <p className="mt-3 text-sm text-white/50">
            We sent a confirmation link to <span className="text-white/80">{email}</span>. Click it to activate your account.
          </p>
          <Link
            href="/auth/login"
            className="mt-6 inline-block text-sm text-[var(--mv-accent)] hover:underline"
          >
            Back to sign in
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-[color:var(--mv-canvas)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-white font-[var(--font-sora)]">Create an account</h1>
          <p className="mt-2 text-sm text-white/50">Get started with Motion Ventures</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-white/40">
          ...
          <Link href="/auth/login" className="text-[var(--mv-accent)] hover:underline">
            Sign in
          </Link>
        </p>
      </div>
